...
class Task(models.Model):
    task_title = models.CharField(max_length=255, db_collation='utf8_general_ci', blank=True, null=True)
    ...
    user_create = models.ForeignKey(AuthUser, models.DO_NOTHING, blank=True, null=True)
